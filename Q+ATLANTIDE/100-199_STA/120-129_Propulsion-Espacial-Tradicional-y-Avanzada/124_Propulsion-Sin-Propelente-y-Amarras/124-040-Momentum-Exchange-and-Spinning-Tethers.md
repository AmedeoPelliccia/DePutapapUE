---
document_id: QATL-ATLAS-1000-STA-120-129-02-124-040
...
subsubject: "040"
subsubject_title: "Momentum Exchange and Spinning Tethers"
...
Defines the `040` subsubject for subsection `124` (*Tether and Propellantless Propulsion*) within STA Section `02`.

## 2. Scope

- Establishes controlled boundaries, interfaces, and assumptions for **Momentum Exchange and Spinning Tethers**.
