---
document_id: QATL-ATLAS-1000-STA-120-129-02-124-060
...
subsubject: "060"
subsubject_title: "Conductive Elements Deployment and Dynamics"
...
Defines the `060` subsubject for subsection `124` (*Tether and Propellantless Propulsion*) within STA Section `02`.

## 2. Scope

- Establishes controlled boundaries, interfaces, and assumptions for **Conductive Elements Deployment and Dynamics**.
