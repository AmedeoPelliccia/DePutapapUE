---
document_id: QATL-ATLAS-1000-STA-120-129-02-124-090
...
subsubject: "090"
subsubject_title: "Safety Debris and Assurance Boundaries"
...
Defines the `090` subsubject for subsection `124` (*Tether and Propellantless Propulsion*) within STA Section `02`.

## 2. Scope

- Establishes controlled boundaries, interfaces, and assumptions for **Safety Debris and Assurance Boundaries**.
