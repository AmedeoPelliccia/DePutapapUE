---
document_id: QATL-ATLAS-1000-STA-120-129-02-124-050
...
subsubject: "050"
subsubject_title: "Aerodynamic Drag and Deorbit Devices"
...
Defines the `050` subsubject for subsection `124` (*Tether and Propellantless Propulsion*) within STA Section `02`.

## 2. Scope

- Establishes controlled boundaries, interfaces, and assumptions for **Aerodynamic Drag and Deorbit Devices**.
