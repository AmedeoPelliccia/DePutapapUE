---
document_id: QATL-ATLAS-1000-STA-120-129-02-124-080
...
subsubject: "080"
subsubject_title: "Performance Bounds and Operational Envelopes"
...
Defines the `080` subsubject for subsection `124` (*Tether and Propellantless Propulsion*) within STA Section `02`.

## 2. Scope

- Establishes controlled boundaries, interfaces, and assumptions for **Performance Bounds and Operational Envelopes**.
