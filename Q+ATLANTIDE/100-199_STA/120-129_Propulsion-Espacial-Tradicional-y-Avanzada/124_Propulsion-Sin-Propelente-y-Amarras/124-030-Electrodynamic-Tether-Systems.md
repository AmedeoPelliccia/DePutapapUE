---
document_id: QATL-ATLAS-1000-STA-120-129-02-124-030
...
subsubject: "030"
subsubject_title: "Electrodynamic Tether Systems"
...
Defines the `030` subsubject for subsection `124` (*Tether and Propellantless Propulsion*) within STA Section `02`.

## 2. Scope

- Establishes controlled boundaries, interfaces, and assumptions for **Electrodynamic Tether Systems**.
