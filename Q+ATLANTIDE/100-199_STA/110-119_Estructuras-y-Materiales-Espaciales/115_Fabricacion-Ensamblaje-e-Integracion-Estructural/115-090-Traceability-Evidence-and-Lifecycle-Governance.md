...
- Concepts in scope:
  ...
  - **Change authority matrix** — FCI manufacturing changes: Q-STRUCTURES + Q-MANUFACTURING + Q-QA + ORB-PMO via DRB; non-FCI structural manufacturing changes: Q-MANUFACTURING + Q-QA; all via DMS revision control.
...
flowchart TB
    ...
    AR --> CCB["CCB Sign-off\n(Q-STRUCTURES · Q-MANUFACTURING · Q-QA · ORB-PMO)"]
